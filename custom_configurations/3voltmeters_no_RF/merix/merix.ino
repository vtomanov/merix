...
/*
  ...
  compile for arduino Mega , upload  and all will be displayed in the serial screen - simulation will have one client ("HOUSE CONSUMERS") 
  which measure - volts, amps and consumption
...
#define Version_Major_Minor_Revision F("Ver.#0.0.399")
...
//                           123456789012345
#define MODULE_SLAVE_NAME F("START")
#endif

#if defined(MODULE_SLAVE_SLAVE_ENABLED)
//                                 123456789012345
#define MODULE_SLAVE_SLAVE_NAME F("FRIDGE")
#endif
...
#define MODULE_SLAVE_SLAVE_TYPE 2
#define MODULE_SLAVE_SLAVE_DISPLAY_TYPE 0
#endif
    ...
    case SERVER_STATE_WORK :
      {
        if (DO_EXECUTE(millis(), SERVER_STATE_WORK_LAST_EXECUTE, SERVER_STATE_DATA_REQUEST_DELAY))
        {
          ...
          if (SERVER_STORE_DATA_REQUEST_INDEX < MAX_CLIENTS)
          {
            ...
            RF_SEND_DATA_REQUEST(SERVER_STORE_CLIENT_ID[SERVER_STORE_DATA_REQUEST_INDEX], SERVER_STORE_CLIENT_INDEX[SERVER_STORE_DATA_REQUEST_INDEX]);
          }
        }
      }; break;
  }
